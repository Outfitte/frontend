...
> **Note:** Versions below 1.0.0 are pre-stable releases. The API contract
> (route shapes, component interfaces, query key conventions) may change between
> minor versions before 1.0.0 is tagged.
